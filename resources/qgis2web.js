...
map.getView().fit([601574.616508, 5528356.625445, 794762.747472, 5653242.724790], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Biodiversité du parc national des Écrins</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (62 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Biodiversité observée dans le parc national des Écrins en 2024';
            }
